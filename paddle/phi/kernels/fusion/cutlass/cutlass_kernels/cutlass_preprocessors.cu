                                    ...
                                    LayoutDetails              details)
{
    ...
    FT_CHECK_WITH_INFO(
        ...
        "The number of rows must be a multiple of %d but the number of rows is %d.", elts_in_int32, num_rows);

    FT_CHECK_WITH_INFO(!(num_cols % rows_per_tile),
                       "The number of columns must be a multiple of %d but the number of columns is %ld",
                              rows_per_tile,
                              num_cols);
    ...
    FT_CHECK_WITH_INFO(!(num_cols % rows_per_tile),
                       "The number of columns must be a multiple of %d but the number of columns is %d.",
                              rows_per_tile,
                              num_cols);
