...
#define warpReduceSum WarpReduceSum
#define warpReduceMax WarpReduceMax
#define warpReduceMin WarpReduceMin
#define blockReduceMax BlockReduceMax
#define blockReduceSum  BlockReduceSum
#define blockReduceMin BlockReduceMax
