...
std::map<std::string, std::set<std::string>> op_ins_map = {
    ...
    {"fused_multi_transformer_moe_int8",
     {"X",
      ...
      "QKVOutScale",
      "OutLinearOutScale",
      "ExpertWeight1OutScale",
      "ExpertWeight2OutScale"}},
...
std::map<std::string, std::set<std::string>> op_outs_map = {
    ...
    {"fused_multi_transformer_weight_only", {"CacheKVOut", "Out"}},
    {"fused_multi_transformer_moe", {"CacheKVOut", "Out"}},
    {"fused_multi_transformer_moe_weight_only", {"CacheKVOut", "Out"}},
...
std::map<std::string, std::set<std::string>> op_passing_outs_map = {
    ...
    {"fused_multi_transformer_weight_only", {"CacheKVOut"}},
    {"fused_multi_transformer_moe", {"CacheKVOut"}},
    {"fused_multi_transformer_moe_weight_only", {"CacheKVOut"}},
