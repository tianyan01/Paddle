...
std::map<std::string, std::set<std::string>> op_ins_map = {
    ...
    {"fused_multi_transformer_int8",
     {"X",           "LnScale",           "LnBias",       "QKVW",
      "QKVBias", "CacheKV", "BeamCacheOffset", "TimeStep", "SeqLengths", "SrcMask",
    ...
    {"fused_multi_transformer_moe_int8",
     {"X", "LnScale", "LnBias", "QKVW",
      "QKVBias", "CacheKV", "BeamCacheOffset", "TimeStep", "SeqLengths", "SrcMask",
      "OutLinearW", "OutLinearBias", "GateWeight", "GateBias", "FFNLnScale", "FFNLnBias",
      "ExpertWeight1", "ExpertBias1", "ExpertWeight2", "ExpertBias2",
      "QKVOutScale", "OutLinearOutScale", "ExpertWeight1OutScale", "ExpertWeight2OutScale"}},
...
std::map<std::string, std::set<std::string>> op_outs_map = {
    ...
    {"fused_multi_transformer_moe", {"CacheKVOut", "Out"}},
    {"fused_multi_transformer_int8", {"CacheKVOut", "Out"}},
    {"fused_multi_transformer_moe_int8", {"CacheKVOut", "Out"}},
    {"resnet_basic_block",
...
std::map<std::string, std::set<std::string>> op_passing_outs_map = {
    ...
    {"fused_multi_transformer_moe", {"CacheKVOut"}},
    {"fused_multi_transformer_int8", {"CacheKVOut"}},
    {"fused_multi_transformer_moe_int8", {"CacheKVOut"}},
